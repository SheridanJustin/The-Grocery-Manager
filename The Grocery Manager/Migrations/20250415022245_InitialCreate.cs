    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientShoppingList", x => new { x.IngredientsIngredientId, x.ShoppingListsShoppingListId });
                    table.ForeignKey(
                        name: "FK_IngredientShoppingList_Ingredients_IngredientsIngredientId",
                        column: x => x.IngredientsIngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "IngredientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientShoppingList_ShoppingLists_ShoppingListsShoppingListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientShoppingList_ShoppingListsShoppingListId",
                table: "IngredientShoppingList",
